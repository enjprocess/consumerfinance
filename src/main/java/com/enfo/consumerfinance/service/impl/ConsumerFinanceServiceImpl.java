...
import com.enfo.consumerfinance.util.TypeFormatUtil;
...
public class ConsumerFinanceServiceImpl implements IConsumerFinanceService {
    ...
    public ProductConsumerModel getProductConsumer(String product_code)
        ...
        try {
            productConsumer = consumerFinanceDao
                    .getProductConsumer(product_code);
    ...
    @Override
    public void checkInvestchangeConsumer(Integer problemId, Integer inputMan)
            throws Exception {
